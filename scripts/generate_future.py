"""Generate futuristic versions of tiles using Gemini image editing.
...
OUTPUT_DIR = ROOT / "tiles_future"
PROMPT_FILE = ROOT / "prompts" / "prompt_future.txt"
...
def main():
    ...
    for i, img_path in enumerate(images):
        ...
        out_path = OUTPUT_DIR / f"future_{img_path.stem}.png"
